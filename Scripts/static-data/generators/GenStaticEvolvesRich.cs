...
{
    protected override async Task<StaticEvolvesRichData> GetData(string[] rootParts)
    {
    ...
    protected override string GetFilenameWithoutExtension() => StaticEvolvesRichLoader.GetFilenameWithoutExtension();
}