                                    ...
                                    saves: attachedVersion
                                        ? {
                                            ...
                                            [ attachedVersion.attachedSaveId! ]: {
                                                ...
                                                order: getSaveOrder(saves, attachedVersion.attachedSaveId!),
                                            },
                                        }
                                        : saves,
                                }),
                ...
                {canEvolveVersion && (
                    <ButtonWithConfirm
                        ...
                        onClick={async () => {
                            ...
                            const mainPkms = Object.values(mutateResult.data.mainPkmVersions?.data ?? {});
                            const newId = mainPkms.find(pkm => pkm.boxKey === mainVersion.boxKey)?.id;
                            if (newId) {
                                navigate({
                                    search: {
                                        selected: {
                    ...
                    <ButtonWithConfirm
                        ...
                        onClick={() =>
                            mainPkmVersionDeleteMutation.mutateAsync({
                                params: {
                                    pkmVersionIds: versions.map(version => version.id),
                                },
                            })
                        }
                    >
