...
> = ({ boxId, anchor }) => {
  ...
  const pkms =
    mainPkmVersionQuery.data?.data.filter((pkm) => ids.includes(pkm.id)) ?? [];
          ...
          >
            ...
            {moveClickable.onClickAttached && (
              <ButtonWithDisabledPopover
                ...
                helpContent={t(
                  "storage.actions.move-attached-main.helpContent",
                )}
              >
              ...
              <ButtonWithConfirm
                ...
                onClick={async () => {
                  await mainPkmVersionDeleteMutation.mutateAsync({
                    params: {
                      pkmVersionIds: canRemovePkms.map(
                        (pkmVersion) => pkmVersion.id,
                      ),
                    },
                  });
                }}
