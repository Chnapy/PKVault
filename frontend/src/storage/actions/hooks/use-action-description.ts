...
export const useActionDescription = () => {
    ...
    return ({ type, parameters }: DataActionPayload): string => {
        ...
        return switchUtil(type, {
            ...
            [ DataActionType.MAIN_CREATE_BANK ]: () => t('storage.save-actions.type.main-create-bank', {
                name: parameters[ 0 ]
            }),
            [ DataActionType.MAIN_UPDATE_BANK ]: () => t('storage.save-actions.type.main-update-bank', {
                name: parameters[ 0 ]
            }),
