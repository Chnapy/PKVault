# Contributing to PKVault

Any desire to contribute to PKVault is truly appreciated, thank you !

PKVault tries to include community in its evolution and avoid any full dependency of a single developer.

## Issues, questions & feature requests

When submitting an issue please provide these data:

- Detailled description of the issue
...
There is no "absolute" rules to follow, just several suggestions:

- Check current documentation:
  - [Functional documentation](../docs/functional/en/README.md)
  - [Technical documentation](../docs/technical/README.md) (including all packages READMEs)
- Keep app consistency
