...
) : DataAction<UpdateExternalPkmActionInput>
{
    ...
    {
        using var _ = Log.Logger.Time($"UpdateExternalPkmAction.HasExternalPkmsToUpdate");
    ...
    {
        using var _ = Log.Logger.Time($"UpdateExternalPkmAction.Execute Adds={input.ExternalPkmsToAdd.Length} Deletes={input.ExternalPkmsToRemove.Length}");
