...
public class PkmFileLoader : IPkmFileLoader
{
    ...
    public async Task WriteToFiles()
    {
        ...
        using var _ = Log.Logger.Time($"PkmFileLoader.WriteToFiles");
        ...
        Log.Debug($"Pkm files to delete: {pkmFilesToDelete.Count}");
        ...
        Log.Debug($"Pkm files to update: {pkmFilesToUpdate.Count}");
