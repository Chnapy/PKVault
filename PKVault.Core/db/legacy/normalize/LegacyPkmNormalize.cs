...
)
{
    ...
    {
        using var _ = Log.Logger.Time($"Pkm normalize: MigrateV0ToV1");
        /**
    ...
    {
        using var _ = Log.Logger.Time($"Pkm normalize: MigrateV1ToV2");
        /**
    ...
    {
        using var _ = Log.Logger.Time($"Pkm normalize: MigrateV2ToV3");
        /**
         * 
         */
        loader.GetAllEntities().Values.ToList().ForEach(pkmEntity =>
    ...
    {
        using var _ = Log.Logger.Time($"Pkm normalize: CleanData remove pkms with no pkmVersions");
