...
public class BackupServiceTests
{
        ...
        GetService(DateTime now, bool throwOnSessionPersist = false)
    {
        ...
        mockSettingsService.Setup(x => x.GetSettings()).Returns(new SettingsDTO(
            BuildID: default, RuntimeSystem: RuntimeSystem.LINUX, Version: "", PkhexVersion: "", AppDirectory: "app", SettingsPath: "", UserId: "",
        ...
        PkmLegalityService pkmLegalityService = new(mockSettingsService.Object, legalityAnalysisService);
